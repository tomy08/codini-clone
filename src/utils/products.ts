...
const products: Product[] = [
  // === PAÑALES ===
  {
    ...
    category: 'Pañales',
    url: 'pampers-premium-care-rn-x36',
  },
  {
    id: 2,
    name: 'Pampers Premium Care M x34',
    price: 9200,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'pampers-premium-care-m-x34',
  },
  {
    id: 3,
    name: 'Pampers Premium Care G x32',
    price: 9500,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'pampers-premium-care-g-x32',
  },
  {
    id: 4,
    name: 'Pampers Premium Care XG x30',
    price: 9800,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'pampers-premium-care-xg-x30',
  },
  {
    id: 5,
    name: 'Pampers Premium Care XXG x28',
    price: 10200,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'pampers-premium-care-xxg-x28',
  },
  {
    id: 6,
    name: 'Huggies Natural Care RN x34',
    price: 7800,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'huggies-natural-care-rn-x34',
  },
  {
    id: 7,
    name: 'Huggies Natural Care M x32',
    price: 8500,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'huggies-natural-care-m-x32',
  },
  {
    id: 8,
    name: 'Huggies Natural Care G x30',
    price: 8800,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'huggies-natural-care-g-x30',
  },
  {
    id: 9,
    name: 'Huggies Natural Care XG x28',
    price: 9200,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'huggies-natural-care-xg-x28',
  },
  {
    id: 10,
    name: 'Babysec Ultra M x34',
    price: 6000,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'babysec-ultra-m-x34',
  },
  {
    id: 11,
    name: 'Babysec Ultra G x32',
    price: 6500,
    discount: 0,
    ...
    category: 'Pañales',
    url: 'babysec-ultra-g-x32',
  },
  {
    id: 12,
    name: 'Babysec Ultra XG x30',
    price: 7000,
    discount: 10,
